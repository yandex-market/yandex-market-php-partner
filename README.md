...
С помощью [партнерского API Яндекс.Маркета](https://tech.yandex.ru/market/partner/doc/dg/concepts/about-docpage/) внешние приложения могут получать сведения о своих магазинах и предложениях и управлять ими. Библиотека реализует работу с партнерским API на языке PHP. 
...
Например, выведем на экран список всех магазинов пользователя Яндекса, на которого зарегистрировано приложение:
